    ...
    63: () => {
      ...
      class Xe {
        ...
        remove(t) {
          ...
          (n && fo(n, t), t instanceof Xe && t._removeParent(this));
        }
      }
      Xe.EMPTY = (() => {
        const e = new Xe();
      ...
      class Ja extends Xe {
        constructor(t) {
          (super(),
            (this.isStopped = !1),
            t
              ? ((this.destination = t), ff(t) && t.add(this))
              : (this.destination = Kw));
        }
        static create(t, n, r) {
          return new ho(t, n, r);
      ...
      const Xw = Function.prototype.bind;
      function Ka(e, t) {
        return Xw.call(e, t);
      }
      class Qw {
      ...
      let ot = (() => {
        ...
        return ((e.create = (t, n) => new vf(t, n)), e);
      })();
      class vf extends ot {
        constructor(t, n) {
        ...
        return new pe((t) => {
          (function P_(e, t) {
            ...
            return (function Cf(e, t, n, r) {
              ...
              try {
                for (n = _f(e); !(r = yield n.next()).done; )
      ...
      function we(e, t, n = 1 / 0) {
        return J(t)
          ? we((r, o) => ee((i, s) => t(r, i, o, s))(it(e(r, o))), n)
          : ("number" == typeof t && (n = t),
            ge((r, o) =>
              (function R_(e, t, n, r, o, i, s, a) {
                const c = [];
                let u = 0,
                  l = 0,
                  d = !1;
      ...
      const jf = "https://g.co/ng/security#xss";
      ...
      function Ui(e) {
        return Hf(e, Bi) || Hf(e, Vf);
      }
      function Hf(e, t) {
        return e.hasOwnProperty(t) ? e[t] : null;
      }
      function $i(e) {
        return e && (e.hasOwnProperty(hc) || e.hasOwnProperty(nb))
          ? e[hc]
          : null;
      }
      const Bi = Y({ ɵprov: Y }),
        hc = Y({ ɵinj: Y }),
        Vf = Y({ ngInjectableDef: Y }),
        nb = Y({ ngInjectorDef: Y });
      var H = (function (e) {
        return (
      ...
      function cb(e, t = H.Default) {
        if (void 0 === er) throw new D(-203, !1);
        return null === er
          ? $f(e, void 0, t)
          : er.get(e, t & H.Optional ? null : void 0, t);
      }
      function M(e, t = H.Default) {
        return (
          (function Uf() {
            return pc;
          })() || cb
      ...
      const xt = {},
        ...
        Gf = Y({ ɵmod: Y }),
        Wt = Y({ ɵfac: Y }),
        yo = Y({ __NG_ELEMENT_ID__: Y }),
        Wf = Y({ __NG_ENV_ID__: Y });
      function Zf(e, t, n) {
        let r = e.length;
        for (;;) {
      ...
      function bc(e, t, n) {
        ...
        for (; r < n.length; ) {
          ...
          if ("number" == typeof o) {
            ...
            const i = o,
              s = n[++r];
            (Xf(i) ? e.setProperty(t, i, s) : e.setAttribute(t, i, s), r++);
          }
        }
        return r;
      }
          ...
          if (null === e || 0 === e.length) e = t.slice();
            ...
            for (let r = 0; r < t.length; r++) {
              ...
              "number" == typeof o
                ? (n = o)
                : 0 === n ||
                  Qf(e, n, o, null, -1 === n || 2 === n ? t[++r] : null);
            }
          }
        return e;
      }
      ...
      function fb(e, t, n) {
        ...
        for (; r < e.length; ) {
          ...
          if ("string" == typeof i && o) {
            const s = e[r++];
            if (n && "class" === i && -1 !== Zf(s.toLowerCase(), t, 0))
              return !0;
          } else {
            if (1 === i) {
          ...
          if ("number" != typeof c) {
            if (!s)
              if (4 & r) {
                ...
                const d = gb(8 & r ? "class" : c, o, Kf(e), n);
                if (-1 === d) {
                  if (yt(r)) return !1;
                  s = !0;
                  continue;
      ...
      function rh(e) {
        ...
        return {
          ...
          hostDirectives: null,
          inputs: nh(e.inputs, t),
          outputs: nh(e.outputs),
        };
      }
      function oh(e) {
      ...
      const ae = 0,
        ...
        Ee = 11;
      function ze(e) {
        return Array.isArray(e) && "object" == typeof e[Ec];
      }
      function ke(e) {
        return Array.isArray(e) && !0 === e[Ec];
      }
      function Mc(e) {
        return 0 != (4 & e.flags);
      }
      ...
      function fh(e) {
        if (!So(e) || e.dirty) {
          if (!e.producerMustRecompute(e) && !gh(e)) return void (e.dirty = !1);
      ...
      function ph(e) {
        ((e.dirty = !0),
          (function hh(e) {
            ...
            Qi = !0;
            try {
              for (const n of e.liveConsumerNode) n.dirty || ph(n);
            } finally {
              Qi = t;
            }
          })(e),
      ...
      function Tc(e) {
        return (e && (e.nextProducerIndex = 0), ct(e));
      }
      function Ac(e, t) {
        if (
          (ct(t),
      ...
      function gh(e) {
        ...
        for (let t = 0; t < e.producerNode.length; t++) {
          ...
          if (r !== n.version || (fh(n), r !== n.version)) return !0;
        }
        return !1;
      }
      function mh(e) {
      ...
      function Ji(e, t) {
        ...
        if (
          ...
          (ar(o), (o.producerIndexOfThis[r] = t));
        }
      }
      function So(e) {
      ...
      function Eh(e) {
        return (e.type.prototype.ngOnChanges && (e.setInput = zb), Bb);
      }
      function Bb() {
        const e = Ih(this),
          t = e?.current;
      ...
      function zb(e, t, n, r) {
        const o = this.declaredInputs[n],
          ...
          a = i.previous,
          c = a[o];
        ((s[o] = new $b(c && c.currentValue, t, a === xt)), (e[r] = t));
      }
      Yt.ngInherit = !0;
      ...
      function Qb(e) {
        1024 & e[F] || ((e[F] |= 1024), Ph(e, 1));
      }
      function Oh(e) {
        1024 & e[F] && ((e[F] &= -1025), Ph(e, -1));
      }
      function Ph(e, t) {
        let n = e[ie];
        if (null === n) return;
      ...
      function Bh(e, t, n) {
        if (n & H.SkipSelf) {
          ...
          for (
            ...
            null !== o ||
              n & H.Host ||
              ((o = dE(i)), null === o || ((i = i[or]), 10 & o.type)));
          );
          if (null === o) return !1;
          ((t = o), (e = i));
        }
      ...
      function Xh(e, t, n, r) {
        const i = r ?? -1,
          s = t.length - 1;
        let a = 0;
        for (let c = void 0 !== r ? 65535 & e[ir] : 0; c < s; c++)
          if ("number" == typeof t[c + 1]) {
            if (((a = t[c]), null != r && a >= r)) break;
          } else
            (t[c] < 0 && (e[ir] += 65536),
              (a < i || -1 == i) &&
                (CE(e, n, t, c), (e[ir] = (4294901760 & e[ir]) + c + 2)),
              c++);
      }
      function Qh(e, t) {
        Rt(4, e, t);
      ...
      function ss(e, t) {
        ...
        let n = 0,
          ...
          o = t;
        for (; null !== o; ) {
          if (((r = cp(o)), null === r)) return dr;
          if ((n++, (o = o[or]), -1 !== r.injectorIndex))
      ...
      function np(e, t, n, r) {
        if (
          ...
          const o = e[mn],
            i = $e(void 0);
          try {
            return o ? o.get(t, r, n & H.Optional) : $f(t, r, n & H.Optional);
          } finally {
            $e(i);
          }
        }
      ...
      function rp(e, t, n, r = H.Default, o) {
        if (null !== e) {
          if (2048 & t[F] && !(r & H.Self)) {
            const s = (function OE(e, t, n, r, o) {
              let i = e,
                s = t;
              for (
                ;
                ...
                const a = op(i, s, n, r | H.Self, kt);
                if (a !== kt) return a;
                let c = i.parent;
                if (!c) {
                  const u = s[sh];
                  if (u) {
                    const l = u.get(n, kt, r);
                    if (l !== kt) return l;
                  }
                  ((c = cp(s)), (s = s[or]));
                }
          ...
          const i = op(e, t, n, r, kt);
          if (i !== kt) return i;
        }
        return np(t, n, r, o);
      }
      function op(e, t, n, r, o) {
        const i = (function TE(e) {
          if ("string" == typeof e) return e.charCodeAt(0) || 0;
          const t = e.hasOwnProperty(yo) ? e[yo] : void 0;
          return "number" == typeof t ? (t >= 0 ? t & Jh : xE) : t;
        })(n);
        if ("function" == typeof i) {
          if (!Bh(t, e, r)) return r & H.Host ? tp(o, 0, r) : np(t, n, r, o);
          try {
            let s;
            if (((s = i(r)), null != s || r & H.Optional)) return s;
            fc();
          } finally {
            Wh();
          }
          ...
          let s = null,
            a = ep(e, t),
            c = dr,
            u = r & H.Host ? t[le][Ae] : null;
          for (
            (-1 === a || r & H.SkipSelf) &&
            ((c = -1 === a ? ss(e, t) : t[a + 8]),
            c !== dr && sp(r, !1)
              ? ((s = t[w]), (a = xo(c)), (t = Oo(c, t)))
              : (a = -1));
            -1 !== a;
          ) {
            const l = t[w];
            if (ip(i, a, l.data)) {
              const d = SE(a, t, n, s, r, u);
              if (d !== kt) return d;
            }
            ((c = t[a + 8]),
              c !== dr && sp(r, t[w].data[a + 8] === u) && ip(i, a, t)
                ? ((s = l), (a = xo(c)), (t = Oo(c, t)))
                : (a = -1));
          }
        }
      ...
      function SE(e, t, n, r, o, i) {
        const s = t[w],
          ...
          l = (function as(e, t, n, r, o) {
            ...
            s,
            n,
            null == r ? Rn(a) && zc : r != s && 0 != (3 & a.type),
            o & H.Host && i === a,
          );
        return null !== l ? Fn(t, s, l, a) : kt;
      }
      function Fn(e, t, n, r) {
        let o = e[n];
        const i = t.data;
        if (
          ...
          try {
            ...
            (null !== u && $e(u), os(a), (s.resolving = !1), Wh());
          }
        }
        return o;
      }
      ...
      class je {
        ...
        get(t, n, r) {
          return rp(this._tNode, this._lView, t, qi(r), n);
        }
      }
      function xE() {
        return new je(Ie(), y());
      ...
      function vr(e, t) {
        e.forEach((n) => (Array.isArray(n) ? vr(n, t) : t(n)));
      }
      function lp(e, t, n) {
      ...
      const ds = vo(gr("Optional"), 8),
        fs = vo(gr("SkipSelf"), 4),
        Dr = "ngSkipHydration";
      function wp(e) {
        const t = Dr.toLowerCase(),
          n = e.mergedAttrs;
        if (null === n) return !1;
      ...
      function ws(e, t) {
        ...
        if (r) {
          const o = r[_o];
          (null !== o && o !== e && kp(o, r), t > 0 && (e[n - 1][Ct] = r[Ct]));
          const i = us(e, Ee + t);
          !(function wM(e, t) {
            (Ho(e, t, t[N], 2, null, null), (t[ae] = null), (t[Ae] = null));
          })(r[w], r);
          const s = i[Ot];
      ...
      function bs(e, t, n, r) {
        ...
        if (null != o)
          if (Array.isArray(n))
            for (let c = 0; c < n.length; c++) jp(i, o, n[c], a, !1);
          else jp(i, o, n, a, !1);
      ...
      function Bp(e, t) {
        return null !== t ? e[le][Ae].projection[t.projection] : null;
      }
      function lu(e, t) {
        const n = Ee + e + 1;
        if (n < t.length) {
      ...
      function du(e, t, n, r, o, i, s) {
        for (; null != n; ) {
          const a = r[n.index],
            c = n.type;
          if (
            (s && 0 === t && (a && xe(ne(a), r), (n.flags |= 2)),
            32 != (32 & n.flags))
          )
            if (8 & c) (du(e, t, n.child, r, o, i, !1), wr(t, e, o, a, i));
            else if (32 & c) {
              const u = ou(n, r);
              let l;
              for (; (l = u()); ) wr(t, e, o, l, i);
              wr(t, e, o, a, i);
            } else 16 & c ? qp(e, t, r, n, o, i) : wr(t, e, o, a, i);
      ...
      function qp(e, t, n, r, o, i) {
        ...
        if (Array.isArray(c))
          for (let u = 0; u < c.length; u++) wr(t, e, o, c[u], i);
        else {
          let u = c;
          const l = s[ie];
      ...
      class Qp {
        ...
        toString() {
          return `SafeValue must use [property]=binding: ${this.changingThisBreaksApplicationSecurity} (see ${jf})`;
        }
      }
      function _n(e) {
        return e instanceof Qp ? e.changingThisBreaksApplicationSecurity : e;
      }
      ...
      function Mr(e) {
        const t = (function $o() {
          const e = y();
          return e && e[rr].sanitizer;
        })();
        return t
          ? t.sanitize(Er.URL, e) || ""
          : (function Vo(e, t) {
                const n = (function zM(e) {
                  return (e instanceof Qp && e.getTypeName()) || null;
                })(e);
                if (null != n && n !== t) {
                  if ("ResourceURL" === n && "URL" === t) return !0;
                  throw new Error(
                    `Required a safe ${t}, got a ${n} (see ${jf})`,
                  );
                }
                return n === t;
              })(e, "URL")
      ...
      const Ir = new b("ENVIRONMENT_INITIALIZER"),
        sg = new b("INJECTOR", -1),
        ag = new b("INJECTOR_DEF_TYPES");
      class Cu {
        get(t, n = mo) {
          if (n === mo) {
      ...
      function aI(...e) {
        return { ɵproviders: cg(0, e), ɵfromNgModule: !0 };
      }
      function cg(e, ...t) {
        const n = [],
          r = new Set();
      ...
      function Ts(e, t, n, r) {
        ...
        if (s) {
          ...
          if (!i) return !1;
          {
            ...
            if (!a) {
              const u = Nn(o) || (() => new o());
              (t({ provide: o, useFactory: u, deps: z }, o),
                t({ provide: ag, useValue: o, multi: !0 }, o),
                t({ provide: Ir, useValue: () => M(o), multi: !0 }, o));
            }
            const c = i.providers;
            if (null != c && !a) {
              const u = e;
      ...
      const cI = Y({ provide: String, useValue: Y });
      function _u(e) {
      ...
      class Os extends lt {
        ...
        constructor(t, n, r, o) {
          (super(),
            ...
            this.records.set(sg, Sr(void 0, this)),
            o.has("environment") && this.records.set(lt, Sr(void 0, this)));
          const i = this.records.get(bu);
          (null != i && "string" == typeof i.value && this.scopes.add(i.value),
            (this.injectorDefTypes = new Set(this.get(ag.multi, z, H.Self))));
        }
        destroy() {
        ...
        get(t, n = mo, r = H.Default) {
          if ((this.assertNotDestroyed(), t.hasOwnProperty(Wf)))
            return t[Wf](this);
          r = qi(r);
          const i = hn(this),
            s = $e(void 0);
          try {
            if (!(r & H.SkipSelf)) {
              ...
              if (void 0 === c) {
                ...
                ((c = u && this.injectableDefInScope(u) ? Sr(Mu(t), As) : null),
                  this.records.set(t, c));
              }
              if (null != c) return this.hydrate(t, c);
            }
            return (r & H.Self ? xs() : this.parent).get(
              t,
              (n = r & H.Optional && n === mo ? null : n),
            );
          } catch (a) {
            if ("NullInjectorError" === a.name) {
              if (((a[zi] = a[zi] || []).unshift(ve(t)), i)) throw a;
        ...
        resolveInjectorInitializers() {
          const t = hn(this),
            n = $e(void 0);
          try {
            const o = this.get(Ir.multi, z, H.Self);
            for (const i of o) i();
          } finally {
            (hn(t), $e(n));
          }
        ...
        processProvider(t) {
          let n = jn((t = P(t))) ? t : P(t && t.provide);
      ...
      function Mu(e) {
        ...
        if (e instanceof Function)
          return (function dI(e) {
            ...
            const n = (function tb(e) {
              return (e && (e[Bi] || e[Vf])) || null;
            })(e);
      ...
      const Ps = new b("AppId", { providedIn: "root", factory: () => mI }),
        mI = "ng",
        hg = new b("Platform Initializer"),
        Tr = new b("Platform ID", {
          providedIn: "platform",
          factory: () => "unknown",
        }),
        pg = new b("CSP nonce", {
        ...
        gg = new b("", { providedIn: "root", factory: () => new Set() });
      function vI() {
        const e = new Ar();
        return (
          "browser" === _(Tr) &&
      ...
      function DI(e, t, n = !1) {
        ...
        let a = {};
        if ("" !== r) {
          const u = t.get(Ar, null, { optional: !0 });
          null !== u && (a = u.get(Ru, [])[Number(r)]);
        }
        const c = { data: a, firstChild: e.firstChild ?? null };
        return (
          n && ((c.firstChild = e), ks(c, 0, e.nextSibling)),
          s ? e.setAttribute(zo, s) : e.removeAttribute(zo),
          c
        );
      }
      function Nu(e, t, n = !1) {
      ...
      function yg(e, t) {
        return e.data[Bo]?.[t] ?? null;
      }
      function Fu(e, t) {
        const n = yg(e, t) ?? [];
        let r = 0;
        for (let o of n) r += o[Or] * (o[Rs] ?? 1);
        return r;
      }
      function Fs(e, t) {
      ...
      const RI = new Hs("16.2.7"),
        Lu = {};
      function Mg(e, t = null, n = null, r) {
        const o = Ig(e, t, n, r);
        return (o.resolveInjectorInitializers(), o);
      }
      function Ig(e, t = null, n = null, r, o = new Set()) {
        const i = [n || z, aI(e)];
        return (
          (r = r || ("object" == typeof e ? void 0 : ve(e))),
          new Os(i, t || xs(), r || null, o)
        );
      }
      let dt = (() => {
        class e {
          static #e = (this.THROW_IF_NOT_FOUND = mo);
          static #t = (this.NULL = new Cu());
          static create(n, r) {
            if (Array.isArray(n)) return Mg({ name: "" }, r, n, "");
            {
              const o = n.name ?? "";
              return Mg({ name: o }, n.parent, n.providers, o);
            }
          }
      ...
      class X {
        constructor({
          ...
          ((o._nesting = 0),
            ...
            (o.nativeRequestAnimationFrame = (function UI() {
            ...
            (function zI(e) {
              ...
              e._inner = e._inner.fork({
                ...
                onInvokeTask: (n, r, o, i, s, a) => {
                  ...
                  try {
                    return (Ag(e), n.invokeTask(o, i, s, a));
                  } finally {
                ...
                onInvoke: (n, r, o, i, s, a, c) => {
                  try {
                    return (Ag(e), n.invoke(o, i, s, a, c));
                  } finally {
        ...
        static assertInAngularZone() {
          if (!X.isInAngularZone()) throw new D(909, !1);
        }
        ...
        runTask(t, n, r, o) {
          const i = this._inner,
            s = i.scheduleEventTask("NgZoneEvent: " + o, t, $I, Tg, Tg);
          try {
      ...
      const Og = new b("", { providedIn: "root", factory: Pg });
      function Pg() {
        const e = _(X);
        let t = !0;
        return (function z_(...e) {
          const t = po(e),
            ...
            r = e;
          return r.length ? (1 === r.length ? it(r[0]) : Jn(n)(_e(r, t))) : Tt;
        })(
          new pe((o) => {
            ((t =
      ...
      const Vs = new b(""),
        Lg = new b("", { providedIn: "root", factory: () => !1 });
      let Us = null;
      function Ug(e, t) {
        return e[t] ?? zg();
      }
      function $g(e, t) {
        const n = zg();
        n.producerNode?.length && ((e[t] = Us), (n.lView = e), (Us = Bg()));
      }
      const nS = {
        ...lh,
        consumerIsAlwaysLive: !0,
      ...
      function S(e, t = H.Default) {
        const n = y();
        return null === n ? M(e, t) : rp(Ie(), n, P(e), t);
      }
      function $s(e, t, n, r, o, i, s, a, c, u, l) {
      ...
      function Wg(e, t, n, r, o) {
        const i = Ug(t, Eo),
          ...
          a = 2 & r;
        try {
          (kn(-1), a && t.length > V && qg(e, t, V, !1), Rt(a ? 2 : 0, o));
          const u = a ? i : null,
            l = Tc(u);
          try {
          ...
          (a && null === t[Eo] && $g(t, Eo), kn(s), Rt(a ? 3 : 1, o));
        }
      }
      function Gu(e, t, n) {
        if (Mc(t)) {
          ...
          ((function vS(e, t, n, r) {
              ...
              (function ES(e, t, n) {
                ...
                const a = Bs(
                  ...
                  $s(
                    ...
                    t,
                    null,
                    e[rr].rendererFactory.createRenderer(r, n),
                    null,
                    null,
                    null,
                  ),
            ...
            for (let a = o; a < i; a++) {
              ...
              (xe(u, t),
                ...
                Dt(c) && (Ke(n.index, t)[ue] = Fn(t, e, a, n)));
            }
          })(e, t, n, qe(n, t)),
          64 == (64 & n.flags) && Kg(e, t, n));
      }
      ...
      function Yu(e, t, n, r, o, i, s, a, c, u, l) {
        const d = V + r,
          f = d + o,
          h = (function oS(e, t) {
            const n = [];
      ...
      function Xg(e, t, n, r) {
        for (let o in e)
          if (e.hasOwnProperty(o)) {
            ...
            null === r
              ? Qg(n, t, o, i)
              : r.hasOwnProperty(o) && Qg(n, t, r[o], i);
          }
        return n;
      }
      function Qg(e, t, n, r) {
      ...
      function Jg(e, t, n, r, o, i) {
        ...
        let s = !1,
          a = !1,
          c = Go(e, t, r.length, null);
        for (let u = 0; u < r.length; u++) {
          const l = r[u];
          ((n.mergedAttrs = Co(n.mergedAttrs, l.hostAttrs)),
            bS(e, n, t, c, l),
            wS(c, l, o),
        ...
        !(function dS(e, t, n) {
          ...
          for (let l = t.directiveStart; l < o; l++) {
            const d = i[l],
              f = n ? n.get(d) : null,
              p = f ? f.outputs : null;
            ((c = Xg(d.inputs, l, c, f ? f.inputs : null)),
              (u = Xg(d.outputs, l, u, p)));
            const g = null === c || null === s || Kf(t) ? null : IS(c, l, s);
            a.push(g);
          }
          (null !== c &&
      ...
      function bS(e, t, n, r, o) {
        ...
        ((e.blueprint[r] = s),
          ...
          })(e, t, r, Go(e, n, o.hostVars, k), o));
      }
      function MS(e, t, n, r, o, i) {
        const s = i[t];
        if (null !== s)
          for (let a = 0; a < s.length; ) em(r, n, s[a++], s[a++], s[a++]);
      }
      ...
      function Bs(e, t) {
        return (e[wo] ? (e[ih][Ct] = t) : (e[wo] = t), (e[ih] = t), t);
      }
      function Ku(e, t, n) {
        jc(0);
        const r = ct(null);
      ...
      function SS(e, t) {
        ...
        const o = n[ae];
        (null !== o && null === n[Zt] && (n[Zt] = Nu(o, n[mn])),
          tl(r, n, n[ue]));
      }
      function tl(e, t, n) {
        Hc(t);
              ...
              s = (function Vb(e, t, n) {
                ...
                return (
                  (r.ref = {
                    notify: () => ph(r),
                    run: () => {
                      if (((r.dirty = !1), r.hasRun && !gh(r))) return;
                      r.hasRun = !0;
                      const s = Tc(r);
                      try {
                        (r.cleanupFn(), (r.cleanupFn = bh), r.fn(o));
                      } finally {
                        Ac(r, s);
                      }
                    },
      ...
      function Wo(e, t, n, r, o = !1) {
        for (; null !== n; ) {
          const i = t[n.index];
          (null !== i && r.push(ne(i)), ke(i) && cm(i, r));
          const s = n.type;
        ...
        if (256 != (256 & o)) {
          ...
          try {
            ...
            if (s) {
              ...
              (null !== u && rs(t, u, 0, null), Uc(t, 0));
            }
            if (
              ((function PS(e) {
                for (let t = Op(e); null !== t; t = Pp(t)) {
                  if (!t[ah]) continue;
                  const n = t[sr];
      ...
      function lm(e, t) {
        for (let n = Op(e); null !== n; n = Pp(n))
          for (let r = Ee; r < n.length; r++) dm(n[r], t);
      }
      function RS(e, t, n) {
        dm(Ke(t, e), n);
      }
      ...
      function fm(e, t, n) {
        for (let r = 0; r < t.length; r++) RS(e, t[r], n);
      }
      class Zo {
        get rootNodes() {
          const t = this._lView,
      ...
      class Yo extends Cg {
        ...
        create(t, n, r, o) {
          ...
          const d = {
              rendererFactory: a,
              sanitizer: s.get(PI, null),
              effectManager: s.get(am, null),
            ...
            p = r
              ? (function iS(e, t, n, r) {
                  const i = r.get(Lg, !1) || n === vt.ShadowDom,
          ...
          let m = null;
          null !== p && (m = Nu(p, s, !0));
          const E = Yu(0, null, null, 1, 0, null, null, null, null, null, null),
            T = $s(null, E, null, C, null, null, d, f, s, null, m);
          let j, Te;
          Hc(T);
          try {
            const $t = this.componentDef;
            ...
            $t.findHostDirectiveDefs
              ? ((Qn = []),
                (lf = new Map()),
                $t.findHostDirectiveDefs($t, Qn, lf),
                Qn.push($t))
              : (Qn = [$t]);
            const YF = (function jS(e, t) {
                const n = e[w],
                  r = V;
                return ((e[r] = t), kr(n, r, 2, "#host", null));
              })(T, p),
              XF = (function HS(e, t, n, r, o, i, s) {
                const a = o[w];
                !(function VS(e, t, n, r) {
                  for (const o of e)
                    t.mergedAttrs = Co(t.mergedAttrs, o.hostAttrs);
                  null !== t.mergedAttrs &&
                    (zs(t, t.mergedAttrs, !0), null !== n && Wp(r, n, t));
                })(r, e, t, s);
                let c = null;
                null !== t && (c = Nu(t, o[mn]));
            ...
            ((Te = Ah(E, V)),
              p &&
                (function $S(e, t, n, r) {
                  if (r) bc(e, n, ["ng-version", RI.full]);
                  else {
                    const { attrs: o, classes: i } = (function _b(e) {
                      const t = [],
                        n = [];
                      let r = 1,
                        o = 2;
              ...
              (j = (function US(e, t, n, r, o, i) {
                const s = Ie(),
                  a = o[w],
                  c = qe(s, o);
                Jg(a, o, s, n, null, r);
                for (let l = 0; l < n.length; l++)
                  xe(Fn(o, a, s.directiveStart + l, s), o);
                (Kg(a, o, s), c && xe(c, o));
                const u = Fn(o, a, s.directiveStart + s.componentOffset, s);
          ...
          return new LS(this.componentType, j, Pr(Te, T), T, Te);
        }
      }
      class LS extends II {
        constructor(t, n, r, o, i) {
          (super(),
            ...
            (this.instance = n),
            (this.hostView = this.changeDetectorRef = new NS(o)),
      ...
      function $r(e, t, n, r, o, i, s, a, c, u, l, d, f, h) {
        const p = (function Xt() {
          return x.lFrame.bindingIndex;
        })();
        let g = (function ft(e, t, n, r, o, i) {
          const s = Hn(e, t, n, r);
          return Hn(e, t + 2, o, i) || s;
        })(e, p, n, o, s, c);
        return (
          (g = Hn(e, p + 4, l, f) || g),
          Qt(6),
        ...
        if (s?.[i])
          ...
          if (
            ...
            if (a) o = u.firstChild;
              ...
              const l = al(c),
                d = ku(e, l);
              o = 2 === c.type && d ? Qs(Fu(e, l) + 1, d) : u.nextSibling;
            }
          }
        }
        return o;
        ...
        const c = y(),
          ...
          d = u.firstCreatePass
            ? (function D0(e, t, n, r, o, i, s, a, c) {
                const u = t.consts,
                  l = kr(t, e, 4, s || null, Cn(u, a));
                (Xu(t, n, l, Cn(u, c)), ts(t, l));
                const d = (l.tView = Yu(
                  2,
                  l,
                  r,
      ...
      let Rm = Nm;
      function Nm(e, t, n, r) {
        return (Dn(!0), t[N].createComment(""));
      }
      function w0(e, t, n, r) {
        const o = t[Zt],
          i = !o || ur() || Fs(o, r);
        if ((Dn(i), i)) return Nm(0, t);
        const s = o.data[xu]?.[r] ?? null;
        null !== s &&
          null !== n.tView &&
          null === n.tView.ssrId &&
          (n.tView.ssrId = s);
        const a = Xs(o, e, t, n);
        return (ks(o, r, a), Qs(Fu(o, r), a));
      }
      function We(e, t, n) {
        const r = y();
        return (
          Oe(r, lr(), t) &&
            (function tt(e, t, n, r, o, i, s, a) {
              ...
              (function se() {
                const e = x.lFrame;
                return Ah(e.tView, e.selectedIndex);
              })(),
              r,
              e,
              t,
      ...
      function ht(e, t, n, r) {
        return (B(e, t, n, r), Z(), ht);
      }
      let km = (e, t, n, r, o, i) => (Dn(!0), Ds(r, o, Zh()));
      function I0(e, t, n, r, o, i) {
        const s = t[Zt],
          a = !s || ur() || Fs(s, i);
        if ((Dn(a), a)) return Ds(r, o, Zh());
        const c = Xs(s, e, t, n);
        return (
          yg(s, i) && ks(s, i, c.nextSibling),
          s &&
            (wp(n) || _p(c)) &&
            Rn(n) &&
            ((function oE(e) {
              x.skipHydrationRootTNode = e;
            })(n),
            zp(c)),
          c
        );
      }
      let Lm = (e, t, n, r) => (Dn(!0), iu(t[N], ""));
      function A0(e, t, n, r) {
        let o;
        const i = t[Zt],
          s = !i || ur();
        if ((Dn(s), s)) return iu(t[N], "");
        const a = Xs(i, e, t, n),
          c = (function MI(e, t) {
            const n = e.data;
            let r = n[Au]?.[t] ?? null;
            return (null === r && n[Bo]?.[t] && (r = Fu(e, t)), r);
          })(i, r);
        return (ks(i, r, a), (o = Qs(c, a)), o);
      }
      function Js(e) {
              ...
              if (g)
                for (let v = 0; v < g; v += 2) {
                  const j = t[p[v]][p[v + 1]].subscribe(i),
                    Te = d.length;
                  (d.push(i, j), u && u.push(o, r.index, Te, -(Te + 1)));
                }
            }
          })(i, o, o[N], s, e, t, r),
          wt
      ...
      function Bm(e, t, n, r, o) {
        return function i(s) {
          ...
          qo(e.componentOffset > -1 ? Ke(e.index, t) : t);
          let c = $m(t, n, r, s),
            u = i.__ngNextListenerFn__;
          for (; u; ) ((c = $m(t, n, u, s) && c), (u = u.__ngNextListenerFn__));
          return (o && !1 === c && s.preventDefault(), c);
        };
      }
      function Gr(e = 1) {
        return (function fE(e) {
          return (x.lFrame.contextLView = (function hE(e, t) {
            for (; e > 0; ) ((t = t[or]), e--);
            return t;
      ...
      function Km(e, t, n, r, o) {
        ...
        for (; 0 !== a && (!1 === c || s); ) {
          const l = e[a + 1];
          (V0(e[a], t) && ((c = !0), (e[a + 1] = r ? gl(l) : hl(l))),
            (a = r ? En(l) : Vn(l)));
        }
        c && (e[n + 1] = r ? hl(i) : gl(i));
      }
      function V0(e, t) {
        return (
          ...
          (!(!Array.isArray(e) || "string" != typeof t) && yr(e, t) >= 0)
        );
      }
      function ml(e, t, n) {
        return (_t(e, t, n, !1), ml);
      }
      function ei(e, t) {
        return (_t(e, t, null, !0), ei);
      }
      function _t(e, t, n, r) {
        const o = y(),
          i = $(),
                ...
                (t = (function Y0(e, t, n, r) {
                  ...
                  if (null === o)
                    0 === (r ? t.classBindings : t.styleBindings) &&
                      ((n = ti((n = vl(null, e, t, n, r)), t.attrs, r)),
                      (i = null));
                  else {
                    const s = t.directiveStylingLast;
                    if (-1 === s || e[s] !== o)
                      if (((n = vl(o, e, t, n, r)), null === i)) {
                        let c = (function X0(e, t, n) {
                          const r = n ? t.classBindings : t.styleBindings;
                          if (0 !== Vn(r)) return e[En(r)];
                        })(e, t, r);
                        void 0 !== c &&
                          Array.isArray(c) &&
                          ((c = vl(null, e, t, c[1], r)),
              ...
              ea(l) ||
                ...
                (function RM(e, t, n, r, o) {
                  if (t) o ? e.addClass(n, r) : e.removeClass(n, r);
                    ...
                    let i = -1 === r.indexOf("-") ? void 0 : wn.DashCase;
                    null == o
                      ? e.removeStyle(n, r, i)
                      : ("string" == typeof o &&
                          o.endsWith("!important") &&
                          ((o = o.slice(0, -10)), (i |= wn.Important)),
                        e.setStyle(n, r, o, i));
                  }
                })(r, s, Ki(Le(), n), o, i));
            })(
      ...
      function vl(e, t, n, r, o) {
        ...
        for (
          ...
          a < s && ((i = t[a]), (r = ti(r, i.hostAttrs, o)), i !== e);
        )
          a++;
      ...
      function lv(e, t, n, r, o, i) {
        ...
        for (; o > 0; ) {
          ...
          let f = n[o + 1];
          f === k && (f = d ? z : void 0);
          let h = d ? Yc(f, r) : l === r ? f : void 0;
          if ((u && !ea(h) && (h = Yc(c, r)), ea(h) && ((a = h), s))) return a;
          const p = e[o + 1];
          o = s ? En(p) : Vn(p);
        }
        if (null !== t) {
      ...
      function Pe(e, t = "") {
        const n = y(),
          ...
          s = fv(r, n, i, t, e);
        ((n[o] = s), es() && bs(r, n, s, i), Nt(i, !1));
      }
      let fv = (e, t, n, r, o) => (Dn(!0), Cs(t[N], r));
      function rT(e, t, n, r, o) {
        const i = t[Zt],
          s = !i || ur() || Fs(i, o);
        return (Dn(s), s ? Cs(t[N], r) : Xs(i, e, t, n));
      }
      function ta(e) {
        return (Zr("", e, ""), ta);
      }
      function Zr(e, t, n) {
        const r = y(),
          o = (function Lr(e, t, n, r) {
            return Oe(e, lr(), n) ? t + R(n) + r : k;
          })(r, e, t, n);
        return (o !== k && tn(r, Le(), o), Zr);
      }
      function yl(e, t, n, r, o, i, s, a, c, u, l, d, f) {
        const h = y(),
          p = $r(h, e, t, n, r, o, i, s, a, c, u, l, d, f);
        return (p !== k && tn(h, Le(), p), yl);
      }
      const Xr = "en-US";
      let Rv = Xr;
      class $n {}
      ...
      class Ml extends $n {
        constructor(t, n, r) {
          (super(),
            ...
            (this.destroyCbs = []),
            (this.componentFactoryResolver = new hm(this)));
          const o = Je(t);
          ...
          getOrCreateStandaloneInjector(n) {
            ...
            if (!this.cachedInjectors.has(n)) {
              const r = cg(0, n.type),
                o =
                  r.length > 0
                    ? Sl([r], this._injector, `Standalone[${n.type.name}]`)
                    : null;
        ...
        if (
          ((function MM(e, t, n, r) {
            ...
            null !== s &&
              ...
              (function IM(e, t) {
                const n = e[sr];
                (t[le] !== t[ie][ie][le] && (e[ah] = !0),
                  null === n ? (e[sr] = [t]) : n.push(t));
              })(s, t);
            const a = t[Ot];
        ...
        rx = class extends nx {
          ...
          createEmbeddedViewImpl(t, n, r) {
            const o = (function ex(e, t, n, r) {
              ...
              const u = e[Ot];
              return (
                null !== u && (a[Ot] = u.createEmbeddedView(o)),
                tl(o, a, n),
                a
              );
      ...
      function ox() {
        return (function sa(e, t) {
          return 4 & e.type ? new rx(t, e, Pr(e, t)) : null;
        })(Ie(), y());
      }
      function Cy(e) {
        const t = e[Io] ?? [],
          r = e[ie][N];
        for (const o of t) ix(o, r);
        e[Io] = z;
      }
      function ix(e, t) {
        let n = 0,
      ...
      function Dy(e) {
        Cy(e);
        for (let t = Ee; t < e.length; t++) aa(e[t]);
      }
      function aa(e) {
        const t = e[w];
        for (let n = V; n < t.bindingStartIndex; n++)
          ke(e[n]) ? Dy(e[n]) : Array.isArray(e[n]) && aa(e[n]);
      }
      let wy = (e, t) => null;
      function cx(e, t) {
        const n = e[Io];
      ...
      function lx() {
        return (function My(e, t) {
          ...
          return (
            ke(r)
              ? (n = r)
              : ((n = tm(r, t, null, e)), (t[e.index] = n), Bs(t, n)),
            Iy(n, t, e, r),
            new by(n, e, t)
          );
        })(Ie(), y());
      ...
      const dx = Et,
        by = class extends dx {
          ...
          createComponent(t, n, r, o, i) {
            ...
            const c = s ? t : new Yo(U(t)),
              u = r || this.parentInjector;
            if (!i && null == c.ngModule) {
              const v = (s ? u : this.parentInjector).get(lt, null);
              v && (i = v);
            }
          ...
          remove(t) {
            ...
            r && (us(xl(this._lContainer), n), su(r[w], r));
          }
          detach(t) {
            const n = this._adjustIndex(t, -1),
              r = ws(this._lContainer, n);
            return r && null != us(xl(this._lContainer), n) ? new Zo(r) : null;
          }
          _adjustIndex(t, n = 0) {
      ...
      function hx(e, t, n, r) {
        ...
        const c = ku(o, i),
          ...
          [l, d] = (function ax(e, t) {
            const n = [];
            for (const r of t)
              for (let o = 0; o < (r[Rs] ?? 1); o++) {
                const i = { data: r, firstChild: null };
                (r[Or] > 0 && ((i.firstChild = e), (e = Qs(r[Or], e))),
                  n.push(i));
              }
            return [e, n];
          })(c, u);
      ...
      const rn = new b("LocaleId", {
        providedIn: "root",
        factory: () =>
          _(rn, H.Optional | H.SkipSelf) ||
          (function Bx() {
        ...
        class e {
          ...
          compileModuleAndAllComponentsSync(n) {
            const r = this.compileModuleSync(n),
              i = en(Je(n).declarations).reduce((s, a) => {
                const c = U(a);
                return (c && s.push(new Yo(c)), s);
              }, []);
            return new Gx(r, i);
          }
      ...
      let Zl,
        ...
        Mn = null;
      const oC = new b("AllowMultipleToken"),
        Yl = new b("PlatformDestroyListeners"),
        da = new b("appBootstrapListener");
      class sC {
        constructor(t, n) {
        ...
        return (i = []) => {
          ...
          if (!s || s.injector.get(oC, !1)) {
            ...
            e
              ? e(a)
              : (function gO(e) {
                  if (Mn && !Mn.get(oC, !1)) throw new D(400, !1);
                  ((function iC() {
                    !(function kb(e) {
                      Ch = e;
                    })(() => {
                  ...
                  (function uC(e = [], t) {
                    return dt.create({
                      ...
                      providers: [
                        ...
                        { provide: Yl, useValue: new Set([() => (Mn = null)]) },
                        ...e,
                      ],
                    });
                  })(a, r),
      ...
      let lC = (() => {
        class e {
          ...
          bootstrapModuleFactory(n, r) {
            const o = (function yO(e = "zone.js", t) {
              return "noop" === e ? new qI() : "zone.js" === e ? new X(t) : e;
            })(
              r?.ngZone,
              (function dC(e) {
                return {
                  ...
                  (function mC(e) {
                    return [
                      { provide: X, useFactory: e },
                      {
                        ...
                        multi: !0,
                        useFactory: () => {
                          const t = _(DO, { optional: !0 });
                          return () => t.initialize();
                        },
                      },
                      { provide: gC, useFactory: CO },
                      { provide: Og, useFactory: Pg },
                    ];
                  })(() => o),
                ),
                s = i.injector.get(Kt, null);
              return (
                o.runOutsideAngular(() => {
                ...
                (function fC(e, t, n) {
                  try {
                    ...
                    return Js(r)
                      ? r.catch((o) => {
                          throw (
                            t.runOutsideAngular(() => e.handleError(o)),
                            o
                          );
                        })
                      : r;
                      ...
                      () => (
                        (function Nv(e) {
                          (at(e, "Expected localeId to be defined"),
                            "string" == typeof e &&
                              (Rv = e.toLowerCase().replace(/_/g, "-")));
                        })(i.injector.get(rn, Xr) || Xr),
          ...
          bootstrapModule(n, r = []) {
            const o = hC({}, r);
            return (function hO(e, t, n) {
              const r = new Il(n);
              return Promise.resolve(r);
            })(0, 0, n).then((i) => this.bootstrapModuleFactory(i, o));
          }
          _moduleDoBootstrap(n) {
            const r = n.injector.get(Bn);
          ...
          destroy() {
            ...
            const n = this._injector.get(Yl, null);
      ...
      let Bn = (() => {
        class e {
          ...
          bootstrap(n, r) {
            const o = n instanceof Cg;
            if (!this._injector.get($l).done)
              throw (
                !o &&
                  (function tr(e) {
                    const t = U(e) || be(e) || Ne(e);
            ...
            const a = (function pO(e) {
                return e.isBoundToModule;
              })(s)
                ? void 0
                : this._injector.get($n),
              u = s.create(dt.NULL, [], r || s.selector, a),
      ...
      const gC = new b("", {
        providedIn: "root",
        factory: () => _(Kt).handleError.bind(void 0),
      });
      function CO() {
        const e = _(X),
          t = _(Kt);
      ...
      let DO = (() => {
        class e {
          constructor() {
            ((this.zone = _(X)), (this.applicationRef = _(Bn)));
          }
          initialize() {
      ...
      let Ql = (() => {
        class e {
          static #e = (this.__NG_ELEMENT_ID__ = _O);
        }
        return e;
      })();
      function _O(e) {
        return (function bO(e, t, n) {
          if (Rn(e) && !n) {
            const r = Ke(e.index, t);
            return new Zo(r, r);
          }
          return 47 & e.type ? new Zo(t[le], t) : null;
        })(Ie(), y(), 16 == (16 & e));
      }
      class DC {
        constructor() {}
          ...
          return (
            ...
            (t =
              ...
              : null !==
                ...
                : (t = this._addAfter(new xO(n, r), i, o)),
            t
          );
        }
      ...
      class wC {
        ...
        put(t) {
          ...
          (r || ((r = new OO()), this.map.set(n, r)), r.add(t));
        }
        get(t, n) {
        ...
        return Du([
          {
            ...
            useFactory: () => {
              let e = !0;
              return (
                Nr() && (e = !!_(Ar, { optional: !0 })?.get(Ru, null)),
                e && _(gg).add("hydration"),
                e
              );
            },
          },
      ...
      const KO = new b("Location Initialized");
      let eP = (() => {
        class e extends id {
          constructor() {
            (super(),
      ...
      let FC = (() => {
          class e extends qn {
            ...
            pushState(n, r, o, i) {
              const s = this.prepareExternalUrl(o + on(i));
        ...
        tP = (() => {
          class e extends qn {
            ...
            pushState(n, r, o, i) {
              let s = this.prepareExternalUrl(o + on(i));
        ...
        ad = (() => {
          class e {
            ...
            static #e = (this.normalizeQueryParams = on);
            static #t = (this.joinWithSlash = sd);
            static #n = (this.stripTrailingSlash = NC);
            ...
            n.forEachOperation((o, i, s) => {
              if (null == o.previousIndex)
                r.createEmbeddedView(
                  this._template,
                  new qP(o.item, this._ngForOf, -1, -1),
                  null === s ? void 0 : s,
                );
      ...
      const iN = new b(""),
        ...
        gN = ["GET", "HEAD"];
      function mN(e, t) {
        const { isCacheActive: n } = _(Pa);
        if (!n || !gN.includes(e.method)) return t(e);
        const r = _(Ar),
          o = (function yN(e) {
      ...
      const Ad = new b("EventManagerPlugins");
      let wD = (() => {
        class e {
          constructor(n, r) {
            ((this._zone = r),
        ...
        class e {
          ...
          getStyleElement(n, r) {
            const o = this.styleNodesInDOM,
              i = o?.get(r);
            if (i?.parentNode === n)
              return (o.delete(r), i.removeAttribute(xd), i);
            {
              const s = this.doc.createElement("style");
              return (
                this.nonce && s.setAttribute("nonce", this.nonce),
                (s.textContent = r),
                this.platformIsServer && s.setAttribute(xd, this.appId),
                s
              );
            }
          }
          ...
          static #e = (this.ɵfac = function (r) {
            return new (r || e)(M(nt), M(Ps), M(pg, 8), M(Tr));
          });
          static #t = (this.ɵprov = I({ token: e, factory: e.ɵfac }));
        }
        return e;
      ...
      const Od = {
        ...
        Pd = /%COMP%/g,
        AN = new b("RemoveStylesOnCompDestroy", {
          providedIn: "root",
          factory: () => !1,
        });
      function MD(e, t) {
            ...
            if (!i) {
              ...
              switch (r.encapsulation) {
                case vt.Emulated:
                  ...
                  break;
                case vt.ShadowDom:
                  return new RN(c, u, n, r, s, a, this.nonce, d);
                default:
      ...
      class Rd {
        ...
        listen(t, n, r) {
          if (
            "string" == typeof t &&
            !(t = Kr().getGlobalEventTarget(this.doc, t))
          )
        ...
        constructor(t, n, r, o, i, s, a, c) {
          ...
          (super(t, n, r, i, s, a, c, u),
            (this.contentAttr = (function xN(e) {
              return "_ngcontent-%COMP%".replace(Pd, e);
            })(u)),
            (this.hostAttr = (function ON(e) {
              return "_nghost-%COMP%".replace(Pd, e);
            })(u)));
        }
        applyToHost(t) {
      ...
      const UN = cC(FO, "browser", [
          { provide: Tr, useValue: "browser" },
          {
            provide: hg,
        ...
        PD = [
          ...
          { provide: rC, useClass: Gl, deps: [X, Wl, la] },
          { provide: Gl, useClass: Gl, deps: [X, Wl, la] },
        ],
        RD = [
          ...
          { provide: Ad, useClass: NN, multi: !0, deps: [nt, X, Tr] },
          { provide: Ad, useClass: LN, multi: !0, deps: [nt] },
          ID,
          bD,
          wD,
          { provide: wg, useExisting: ID },
          { provide: class bR {}, useClass: MN, deps: [] },
          [],
        ];
      let BN = (() => {
          class e {
        ...
        return Du([
          ...
          n.has(1)
            ...
            : [
                ...
                { provide: iN, useValue: mN, multi: !0, deps: [Ar, Pa] },
                {
                  provide: da,
                  multi: !0,
                  useFactory: () => {
      ...
      const { isArray: JN } = Array,
        { getPrototypeOf: KN, prototype: e1, keys: t1 } = Object;
      ...
      function Fd(...e) {
        const t = po(e),
          ...
          { args: r, keys: o } = (function n1(e) {
            if (1 === e.length) {
              const t = e[0];
              if (JN(t)) return { args: t, keys: null };
              if (
                (function r1(e) {
                  return e && "object" == typeof e && KN(e) === e1;
                })(t)
              ) {
                const n = t1(t);
      ...
      function Tn(e) {
        return (function QN(e) {
          return !!e && (e instanceof pe || (J(e.lift) && J(e.subscribe)));
        })(e)
          ? e
          : Js(e)
            ? _e(Promise.resolve(e))
            : O(e);
      }
      const D1 = {
        ...
        BD = {
          ...
          subset: function _1(e, t) {
            return (
              ...
              Object.keys(t).every((n) => UD(e[n], t[n]))
            );
          },
          ignored: () => !0,
        };
      ...
      function WD(e, t, n, r) {
        ...
        }
        {
          ...
          return (
            !!(Yn(e.segments, o) && Na(e.segments, o, r) && e.children[L]) &&
      ...
      const M1 = new Ud();
      function ka(e) {
        return e.segments.map((t) => XD(t)).join("/");
      }
      function _i(e, t) {
      ...
      class F1 {
        ...
        parseChildren() {
          ...
          return (
            ...
            (t.length > 0 || Object.keys(n).length > 0) && (r[L] = new Q(t, n)),
            r
          );
        }
        parseSegment() {
        ...
        parseParens(t) {
          ...
          for (
            ...
            ((n[i] = 1 === Object.keys(s).length ? s[L] : new Q([], s)),
              this.consumeOptional("//"));
          }
          return n;
        }
      ...
      function ew(e, t, n, r) {
        ...
        if (i.toRoot()) return zd(o, o, new Q([], {}), n, r);
        const s = (function V1(e, t, n) {
          ...
          a = s.processChildren
            ? Ei(s.segmentGroup, s.index, i.commands)
            : rw(s.segmentGroup, s.index, i.commands);
        return zd(o, s.segmentGroup, a, n, r);
      }
      function ja(e) {
        return (
      ...
      function rw(e, t, n) {
        ...
        if (r.match && r.pathIndex < e.segments.length) {
          ...
          return (
            (i.children[L] = new Q(e.segments.slice(r.pathIndex), e.children)),
            Ei(i, 0, o)
          );
        }
      ...
      function Ei(e, t, n) {
        ...
        {
          const r = (function $1(e) {
              return bi(e[0]) ? e[0].outlets : { [L]: e };
            })(n),
            o = {};
          if (
      ...
      class uw extends cw {
        constructor(t, n) {
          (super(t), (this.snapshot = n), Xd(this, t));
        }
        toString() {
      ...
      function lw(e, t) {
        const n = (function nk(e, t) {
            const s = new $a([], {}, {}, "", {}, L, t, null, {});
            return new fw("", new cn(s, []));
          })(0, t),
          r = new st([new Di("", {})]),
          o = new st({}),
          i = new st({}),
          s = new st({}),
          a = new st(""),
          c = new io(r, o, s, a, i, L, t, n.root);
        return ((c.snapshot = n.root), new uw(new cn(c, []), n));
      }
      class io {
        constructor(t, n, r, o, i, s, a, c) {
          ((this.urlSubject = t),
            ...
            (this.title =
              this.dataSubject?.pipe(ee((u) => u[Ci])) ?? O(void 0)),
            (this.url = t),
            (this.params = n),
            (this.queryParams = r),
            (this.fragment = o),
        ...
        get paramMap() {
          return (
            this._paramMap ||
              (this._paramMap = this.params.pipe(ee((t) => to(t)))),
            this._paramMap
          );
        }
        get queryParamMap() {
          return (
            this._queryParamMap ||
              (this._queryParamMap = this.queryParams.pipe(ee((t) => to(t)))),
            this._queryParamMap
          );
        }
        toString() {
      ...
      class $a {
        ...
        get paramMap() {
          return (
            this._paramMap || (this._paramMap = to(this.params)),
            this._paramMap
          );
        }
        get queryParamMap() {
      ...
      function Xd(e, t) {
        ((t.value._routerState = e), t.children.forEach((n) => Xd(e, n)));
      }
      function hw(e) {
        const t =
        ...
        class e {
          constructor() {
            ((this.activated = null),
              ...
              (this.location = _(Et)),
              (this.changeDetector = _(Ql)),
              (this.environmentInjector = _(lt)),
              (this.inputBinder = _(Ba, { optional: !0 })),
        ...
        class e {
          ...
          subscribeToRouteData(n) {
            const { activatedRoute: r } = n,
              o = Fd([r.queryParams, r.params, r.data])
                .pipe(
                  At(
                    ([i, s, a], c) => (
                      (a = { ...i, ...s, ...a }),
                      0 === c ? O(a) : Promise.resolve(a)
                    ),
                  ),
                )
                .subscribe((i) => {
      ...
      const Kd = "ngNavigationCancelingError";
      function mw(e, t) {
      ...
      function vw(e, t, n) {
        ...
        return ((r[Kd] = !0), (r.cancellationCode = t), n && (r.url = n), r);
      }
      function yw(e) {
        return e && e[Kd];
      }
      ...
      function xi(
        ...
        return (
                ...
                const c = (function Ck(e, t, n) {
                  ...
                  switch (n) {
                    ...
                    case "paramsOrQueryParamsChange":
                      return !Jd(e, t) || !Vt(e.queryParams, t.queryParams);
                    default:
                      return !Jd(e, t);
                  }
          ...
          Object.entries(i).forEach(([s, a]) => Oi(a, n.getContext(s), o)),
          o
        );
      }
      function Oi(e, t, n) {
        const r = oo(e),
          o = e.value;
        (Object.entries(r).forEach(([i, s]) => {
          Oi(s, o.component ? (t ? t.children.getContext(i) : null) : t, n);
        }),
          ...
          Fd(
            ...
            ee((t) => {
              for (const n of t)
                if (!0 !== n) {
                  if (n === qa) return qa;
                  if (!1 === n || n instanceof no) return n;
                }
              return !0;
            }),
            fn((t) => t !== qa),
        ...
        return i.matched
          ? ((r = (function uk(e, t) {
              return (
                e.providers &&
                  !e._injector &&
                  (e._injector = Sl(e.providers, t, `Route: ${e.path}`)),
                e._injector ?? t
              );
            })(t, r)),
            (function Fk(e, t, n, r) {
      ...
      function Mw(e, t, n, r) {
        return n.length > 0 &&
          (function Bk(e, t, n) {
            return n.some((r) => Wa(e, t, r) && St(r) !== L);
          })(e, n, r)
          ? {
              segmentGroup: new Q(t, $k(r, new Q(n, e.children))),
              slicedSegments: [],
            }
          : 0 === n.length &&
              (function zk(e, t, n) {
            ...
            ? {
                segmentGroup: new Q(e.segments, Uk(e, 0, n, r, e.children)),
                slicedSegments: n,
              }
            : {
                segmentGroup: new Q(e.segments, e.children),
                slicedSegments: n,
              };
      }
          ...
          return _e(n).pipe(
            yi((a) =>
              this.processSegmentAgainstRoute(
                ...
                Zn((c) => {
                  if (c instanceof Ga) return O(null);
                  throw c;
                }),
              ),
            ),
        ...
        expandRegularSegmentAgainstRouteUsingRedirect(t, n, r, o, i, s) {
          ...
          return o.redirectTo.startsWith("/")
            ...
            : this.applyRedirects
                ...
                .pipe(
                  we((f) => this.processSegment(t, r, n, f.concat(u), s, !1)),
                );
        }
        matchSegmentAgainstRoute(t, n, r, o, i, s) {
          let a;
          if ("**" === r.path) {
            const c = o.length > 0 ? $D(o).parameters : {};
            ((a = O({
              snapshot: new $a(
                o,
                c,
      ...
      function rf(e) {
        return At((t) => {
          const n = e(t);
          return n ? _e(n).pipe(ee(() => t)) : O(t);
        });
      }
      const uo = new b("ROUTES");
      let sf = (() => {
        class e {
          constructor() {
          ...
          loadComponent(n) {
            ...
            const r = Tn(n.loadComponent()).pipe(
                ee(xw),
                Se((i) => {
                    ...
                    return (
                      Array.isArray(o)
                        ...
                        : ((i = o.create(n).injector),
                          (s = i
                            .get(uo, [], { optional: !0, self: !0 })
                            .flat())),
                      { routes: s.map(ef), injector: i }
                    );
                  }),
                );
                ...
                At((i) => {
                  ...
                  return O(i).pipe(
                    ...
                    At((c) => {
                      ...
                      if (
                        ...
                        const {
                          ...
                          C = new Va(f, this.urlSerializer.serialize(h), p, g);
                        this.events.next(C);
                    ...
                    rf((c) => {
                      ...
                      return Fd(u(c.targetSnapshot.root)).pipe(Hi(), Kn(1));
                    }),
                    rf(() => this.afterPreactivation()),
                    ee((c) => {
                    ...
                    (function m1(e) {
                      return ge((t, n) => {
                        (it(e).subscribe(me(n, () => n.complete(), Xa)),
      ...
      function Rw(e, t) {
        e.events
          .pipe(
            ...
            ee((n) =>
              n instanceof An || n instanceof ro
                ? Ri.COMPLETE
                : n instanceof Ii && (0 === n.code || 1 === n.code)
                  ? Ri.REDIRECTING
                  : Ri.FAILED,
            ),
            fn((n) => n !== Ri.REDIRECTING),
            Kn(1),
          )
          .subscribe(() => {
            t();
        ...
        class e {
          ...
          constructor() {
            ((this.disposed = !1),
              ...
              (this.config = _(uo, { optional: !0 })?.flat() ?? []),
              (this.navigationTransitions = _(Za)),
              (this.urlSerializer = _(wi)),
              (this.location = _(ad)),
              (this.componentInputBindingEnabled = !!_(Ba, { optional: !0 })),
              (this.eventsSubscription = new Xe()),
              (this.isNgZoneEnabled = _(X) instanceof X && X.isInAngularZone()),
              this.resetConfig(this.config),
              (this.currentUrlTree = new no()),
          ...
          subscribeToNavigationEvents() {
            const n = this.navigationTransitions.events.subscribe((r) => {
              try {
                ...
                if (null === o) return void (Nw(r) && this._events.next(r));
                if (r instanceof Va)
                  Ow(o.source) && (this.browserUrlTree = o.extractedUrl);
                else if (r instanceof ro) this.rawUrlTree = o.rawUrl;
                  ...
                  const i = this.urlHandlingStrategy.merge(
                    ...
                    s = {
                      ...
                      replaceUrl:
                        "eager" === this.urlUpdateStrategy || Ow(o.source),
                    };
                ...
                (r instanceof Ua && this.restoreHistory(o, !0),
                  r instanceof An && (this.navigated = !0),
                  Nw(r) && this._events.next(r));
              } catch (o) {
      ...
      function Nw(e) {
        return !(e instanceof Gd || e instanceof Wd);
      }
      class kw {}
      let yF = (() => {
        class e {
          ...
          processRoutes(n, r) {
            ...
            for (const i of r) {
              i.providers &&
                !i._injector &&
                (i._injector = Sl(i.providers, n, `Route: ${i.path}`));
          ...
          preloadConfig(n, r) {
            return this.preloadingStrategy.preload(r, () => {
              ...
              return r.loadComponent && !r._loadedComponent
                ? _e([i, this.loader.loadComponent(r)]).pipe(Jn())
                : i;
            });
          }
          static #e = (this.ɵfac = function (r) {
            return new (r || e)(M(mt), M(Ky), M(lt), M(kw), M(sf));
          });
          static #t = (this.ɵprov = I({
            token: e,
            factory: e.ɵfac,
      ...
      function jw() {
        ...
        return (t) => {
          ...
          const r = e.get(mt),
            o = e.get(Hw);
          (1 === e.get(uf) && r.initialNavigation(),
            e.get(Vw, null, H.Optional)?.setUpPreloading(),
            e.get(cf, null, H.Optional)?.init(),
            r.resetRootComponentType(n.componentTypes[0]),
            o.closed || (o.next(), o.complete(), o.unsubscribe()));
        };
      }
      const Hw = new b("", { factory: () => new ot() }),
        uf = new b("", { providedIn: "root", factory: () => 1 }),
        Vw = new b("");
      function _F(e) {
        return un(0, [
          { provide: Vw, useExisting: yF },
          { provide: kw, useExisting: e },
        ]);
      }
      const Uw = new b("ROUTER_FORROOT_GUARD"),
        EF = [
          ad,
          { provide: wi, useClass: Ud },
          mt,
          Si,
          {
            provide: io,
      ...
      let $w = (() => {
        class e {
          ...
          static forRoot(n, r) {
            return {
              ...
              providers: [
                EF,
                [],
                { provide: uo, multi: !0, useValue: n },
                {
                  provide: Uw,
                  useFactory: AF,
                  deps: [[mt, new ds(), new fs()]],
                },
                { provide: Ya, useValue: r || {} },
                r?.useHash
                  ? { provide: qn, useClass: tP }
                  : { provide: qn, useClass: FC },
                {
                  provide: cf,
                  useFactory: () => {
                    const e = _(DR),
                ...
                r?.initialNavigation ? xF(r) : [],
                r?.bindToComponentInputs
                  ? un(8, [gw, { provide: Ba, useExisting: gw }]).ɵproviders
                  : [],
                [
                  { provide: Bw, useFactory: jw },
                  { provide: da, multi: !0, useExisting: Bw },
                ],
              ],
            };
          }
          static forChild(n) {
            return {
              ngModule: e,
              providers: [{ provide: uo, multi: !0, useValue: n }],
            };
          }
          static #e = (this.ɵfac = function (r) {
            return new (r || e)(M(Uw, 8));
          });
          static #t = (this.ɵmod = gn({ type: e }));
          static #n = (this.ɵinj = qt({}));
        }
          ...
          "enabledBlocking" === e.initialNavigation
            ? un(2, [
                { provide: uf, useValue: 0 },
                {
                  ...
                  deps: [dt],
                  useFactory: (t) => {
                    const n = t.get(KO, Promise.resolve());
                    return () =>
                      n.then(
                        () =>
                          new Promise((r) => {
      ...
      let RF = (() => {
        class e {
          ...
          static #n = (this.ɵinj = qt({
            imports: [
              $w.forRoot(PF, { initialNavigation: "enabledBlocking" }),
              $w,
            ],
          }));
        }
      ...
      let kF = (() => {
          class e {
            ...
            copy(n) {
              ...
              return this.pushCopyResponse(
                r
                  ? { content: n, isSuccess: r }
                  : { isSuccess: !1, content: n },
              );
            }
            get isSupported() {
              return (
          ...
          return (
            (e.ɵfac = function (n) {
              return new (n || e)(M(X), M(nt), M(NF, 8));
            }),
            ...
            static #t = (this.ɵcmp = pn({
              ...
              template: function (r, o) {
                (1 & r &&
                  ...
                  Z(),
                  B(4, "div", 4)(5, "h1"),
                  Pe(6, "Ahmad Bayrakdar"),
                  Z(),
                  B(7, "h2"),
                  Pe(8),
                  Z()()(),
                  B(9, "div", 5)(10, "div", 6)(11, "a", 7),
                  wt("click", function () {
                  ...
                  Z()(),
                  B(21, "p"),
                  Pe(22, "ahmad.berkdar.sy@gmail.com"),
                  Z(),
                  B(23, "p"),
                  Pe(24, "+201080857997"),
                  Z()(),
        ...
        class e {
          constructor() {
            ((this.activeOption = "Programming"),
              (this.activeOptionChange = new De()));
          }
          setActiveOption(n) {
          ...
          static #t = (this.ɵcmp = pn({
            ...
            template: function (r, o) {
              (1 & r &&
                ...
                2 & r &&
                  (fe(1),
                  ei("active", "Programming" === o.activeOption),
                  fe(3),
                  ei("active", "Programming" === o.activeOption)));
            },
            styles: [
      ...
      const qw = [
        {
          title: "David Rivero",
          description: "Business Website for an Entrepreneur, USA",
          link: "https://davidrivero.com/",
          image: "../assets/images/davidrivero.png",
          tags: ["PHP", "CSS", "Javascript", "SEO"],
          speciality: "Web",
        ...
        {
          title: "Thegrowth Talks",
          description: "Event Website for business men, USA",
          link: "https://thegrowthtalks.com/",
          image: "../assets/images/thegrowthtalks.png",
        ...
        {
          title: "Shrubhub",
          description: "Business Website for a 3D Design company, USA",
          link: "https://www.shrubhub.com/",
          image: "../assets/images/shrubhub.png",
          tags: ["PHP", "CSS", "Javascript", "SEO"],
          speciality: "Web",
          backgroundColor: "#549e5c",
          color: "#000",
          buttonText: "View Project",
        },
        {
          ...
          image: "../assets/images/BigMedia.png",
        ...
        {
          title: "Ranem Yatakan",
          description: "E-Booking system for a life coach, UK",
          link: "https://app.ranemyatakan.com/",
          image: "../assets/images/Ranem-Yatakan.png",
        ...
        {
          title: "My Portfolio",
          description: "Personal website (my portfolio since 2024), EG",
        ...
        },
        {
          ...
          image: "../assets/images/Proitx.png",
          tags: [
            "HTML",
            "CSS",
            "Javascript",
        ...
        {
          title: "Sna Academy",
          description: "E-Learning system for an academy, SA",
          image: "../assets/images/Sna-Academy.png",
          tags: ["php", "Laravel", "HTML", "CSS", "Javascript", "jQuery"],
          speciality: "Web",
        ...
        },
        {
          ...
          image: "../assets/images/Afaq-lms.png",
          tags: ["php", "Laravel", "HTML", "CSS", "Javascript", "jQuery"],
          speciality: "Web",
          backgroundColor: "#0c527e",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Afaq Staff Badge",
          description: "Dynamic Badge for Afaq Staffs, SA",
          link: "../assets/websites/id-card for afaq/",
          image: "../assets/images/afaq-staff-badge.png",
          tags: ["HTML", "CSS"],
          speciality: "Web",
        ...
        {
          title: "Evntoo",
          description: "E-Reservation system for a company, EG",
          image: "../assets/images/Evntoo.png",
          tags: ["Angular", "CSS", "Javascript", "jQuery"],
          speciality: "Web",
          backgroundColor: "#e6ac49",
          color: "#000",
          buttonText: "View Project",
        },
        {
          title: "DmedLab",
          description: "Encyclopedia web page for a mobile application, UAE",
          link: "https://dmedlab.com/",
          image: "../assets/images/DmedLab.png",
          tags: ["HTML", "CSS", "Javascript", "Bootstrap"],
          speciality: "Web",
          backgroundColor: "#0087fd",
          color: "#000",
          buttonText: "View Project",
        },
        {
          title: "Ozone NDT",
          description: "E-Commerce Website for a company, CA",
          link: "https://dev.ozonendt.com/",
          image: "../assets/images/Ozone-NDT.png",
          tags: [
            "WordPress",
            "Woocommerce",
            "Authentication",
        ...
        },
        {
          ...
          description: "E-Commerce Website for a company, EG",
          link: "https://elmalekfurniture.com/",
          image: "../assets/images/Elmalek-Furniture.png",
          tags: [
            "WordPress",
            "Woocommerce",
            "Authentication",
          ...
          speciality: "Web",
          backgroundColor: "#b59475",
          color: "#000",
          buttonText: "View Project",
        },
        {
          title: "NasNav",
          description: "Product web page with add to cart, EG",
          image: "../assets/images/NasNav.png",
        ...
        },
        {
          ...
          image: "../assets/images/Proitx-old.png",
          tags: [
            "HTML",
            "CSS",
            "Javascript",
        ...
        },
        {
          ...
          image: "../assets/images/Proitx-old-2.png",
        ...
        },
        {
          ...
          description: "Personal website (my portfolio in 2023), EG",
          link: "https://www.bayrakdar.online/old-portfolio-2023/",
          image: "../assets/images/My-Old-Portfolio.png",
          tags: ["HTML", "CSS", "CSS Animation", "Javascript"],
          speciality: "Web",
          backgroundColor: "#192010",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "My Older Portfolio",
          description: "Personal website (my first portfolio in 2023), EG",
          link: "https://www.bayrakdar.online/old_portfolio/",
          image: "../assets/images/My-Older-Portfolio.png",
        ...
        {
          title: "Preneom",
          description: "Website Landing Page for IT Company, UAE",
          link: "https://preneom.com/",
          image: "../assets/images/preneom.png",
          tags: ["HTML", "CSS"],
          speciality: "Web",
        ...
        },
        {
          title: "Mad",
          description:
            "Simple webpage I did when I was learning the basics, SY",
        ...
        },
        {
          ...
          image: "../assets/images/Coloured.png",
          tags: ["HTML", "CSS"],
          speciality: "Web",
        ...
        },
        {
          title: "Dmedlab",
          description:
            "Mobile App Design for online medical laboratory encyclopedia, UAE",
          image: "../assets/images/dmedlab-ui.jpg",
          tags: ["UI", "Figma", "Adobe Illustrator"],
          speciality: "Ux Ui",
        ...
        {
          title: "Dmedlab Dashboard",
          description:
            "Web Dashboard Design for managing the app system Dmedlab, UAE",
          image: "../assets/images/dmedlab-dashboard.png",
          tags: ["UI", "Figma", "Adobe Illustrator"],
          speciality: "Ux Ui",
          backgroundColor: "#0084F7",
          color: "#fff",
        ...
        {
          title: "Dmedlab Awareness",
          description: "Mobile App awareness for Dmedlab, UAE",
          image: "../assets/images/dmedlab-awareness.jpg",
          tags: ["UI", "Figma", "Adobe Illustrator"],
          speciality: "Ux Ui",
          backgroundColor: "#0084F7",
          color: "#fff",
        ...
        },
        {
          title: "Smart Lab",
          description:
            "Software Design for managing medical laboratory systems, SY",
        ...
        {
          title: "Starfisher",
          description: "Mobile App Design for entertainment company, UAE",
          image: "../assets/images/starfisher.jpg",
          tags: ["UI", "Figma", "Adobe Photoshop", "Generative Fill"],
          speciality: "Ux Ui",
        ...
        {
          title: "Evntoo Awareness",
          description: "Mobile App awareness for a business company, EG",
          image: "../assets/images/Evntoo Awareness.jpg",
          tags: ["UI", "Figma", "Adobe Illustrator", "Adobe After Effects"],
          speciality: "Ux Ui",
        ...
        },
        {
          title: "Evntoo Awareness",
          description: "Mobile App awareness for a business company, EG",
          image: "../assets/images/Evntoo Awareness2.jpg",
          tags: ["UI", "Figma", "Adobe Illustrator", "Adobe Photoshop"],
          speciality: "Ux Ui",
          backgroundColor: "#53182a",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Afaq Awareness",
          description: "Mobile App awareness for an E-Learning App, SA",
          image: "../assets/images/Afaq Awareness.jpg",
          tags: ["UI", "Figma", "Adobe Illustrator"],
          speciality: "Ux Ui",
          backgroundColor: "#0e4d76",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "My Portfolio",
          description: "UI Design for my portfolio, EG",
          image: "../assets/images/portfolioUI.png",
          tags: ["UI", "Figma", "Adobe Illustrator"],
          speciality: "Ux Ui",
        ...
        {
          title: "Yes-Soft UI",
          description: "Web Design for IT company, DE",
          image: "../assets/images/Yes-Soft.png",
          tags: ["UI", "Adobe XD", "Adobe Illustrator"],
          speciality: "Ux Ui",
          backgroundColor: "#45a9b7",
          color: "#000",
          buttonText: "View Project",
        },
        {
          title: "Yes-Soft UX",
          description: "Web UX for IT company, DE",
          image: "../assets/images/Yes-Soft-UX.png",
          tags: ["UX", "Analytics", "Adobe XD"],
          speciality: "Ux Ui",
        ...
        {
          title: "Takephoto",
          description: "Web Ui for web applocation, UAE",
          image: "../assets/images/takephoto.png",
          tags: ["UI", "Figma"],
          speciality: "Ux Ui",
          backgroundColor: "#0C4942",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Pizza & Burger",
          description: "Web Design for restaurants chain, SY",
          image: "../assets/images/Pizza-&-Burger.png",
          tags: ["UI", "Adobe XD", "Adobe Illustrator", "Adobe Photoshop"],
          speciality: "Ux Ui",
          backgroundColor: "#301a0f",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Raykira Illustrator",
          description: "Web Design for my Character Art Design, SY",
          image: "../assets/images/Raykira-Illustrator.png",
          tags: ["UI", "Adobe XD", "Adobe Illustrator", "Adobe Photoshop"],
          speciality: "Ux Ui",
          backgroundColor: "#530a8d",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Raykira",
          description: "Web Design for My Old Graphic Design Company, SY",
          image: "../assets/images/Old-Raykira-website.png",
          tags: ["UI", "UX", "Adobe XD", "Adobe Illustrator"],
          speciality: "Ux Ui",
          backgroundColor: "#fa2856",
          color: "#fff",
          buttonText: "View Project",
        },
        {
          title: "Raykira Webimage",
          description:
            "Windows Application for big Businesses to resize products images and place logo, SY",
          link: "https://drive.google.com/file/d/1CufcK1SWwVsdUyfEy7goCrUUeZ3waen_/view?usp=sharing",
          image: "../assets/images/Raykira-Webimage.png",
          tags: ["Python"],
          speciality: "Desktop",
        ...
        {
          title: "DYP",
          description: "Mobile App for E-Learning System - 3 styles, SY",
          link: "../assets/pdf/DYP.pdf",
          image: "../assets/images/DYP.jpg",
          tags: ["React Native", "PHP", "SQL"],
          speciality: "Mobile",
          backgroundColor: "#1A2E35",
          color: "#fff",
          buttonText: "View Project",
      ...
      function HF(e, t) {
        if ((1 & e && (B(0, "div", 11), Pe(1), Z()), 2 & e)) {
          const n = t.$implicit;
          (fe(1), Zr(" ", n, " "));
        }
      }
      function VF(e, t) {
        if ((1 & e && (B(0, "a", 12), Pe(1), Z()), 2 & e)) {
          const n = Gr(2).$implicit;
          (We("href", n.link, Mr), fe(1), Zr(" ", n.buttonText, " "));
        }
      }
      function UF(e, t) {
        if (
          ...
          const n = Gr().$implicit;
          (ml("background-color", n.backgroundColor)("color", n.color),
            fe(2),
            We("src", n.image || "../../assets/images/default image.png", Mr),
            fe(2),
            ta(n.title),
            fe(3),
            ta(n.description),
      ...
      function $F(e, t) {
        if (
          (1 & e && (B(0, "div", 1), qr(1, UF, 12, 9, "div", 2), Z()), 2 & e)
        ) {
          const n = t.$implicit,
            r = Gr();
          (fe(1), We("ngIf", n.speciality == r.Route));
        }
      }
      let BF = (() => {
        class e {
          ...
          static #t = (this.ɵcmp = pn({
            ...
            consts: [
              ...
              [1, "tagElement"],
              ["target", "_blank", 1, "viewProjectText", 3, "href"],
            ],
            template: function (r, o) {
              (1 & r && qr(0, $F, 2, 1, "div", 0),
                2 & r && We("ngForOf", o.projectItems));
            },
            dependencies: [yd, YC],
            styles: [
              '.cardComponent[_ngcontent-%COMP%]{display:flex;flex-direction:column;text-align:center;gap:11px;border:solid 2px #000;width:clamp(100px,25vw,350px);color:#000;text-decoration:none;transition:box-shadow .2s ease-in-out;height:100%}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]{overflow:hidden;position:relative;height:clamp(110px,20vw,175px)}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{width:100%;height:100%;object-fit:contain}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]:after{content:"";position:absolute;top:0;left:0;width:100%;height:100%}.cardComponent[_ngcontent-%COMP%]   .viewProject[_ngcontent-%COMP%]{flex-grow:1;display:flex;flex-direction:column;justify-content:flex-end}.cardComponent[_ngcontent-%COMP%]   .viewProject[_ngcontent-%COMP%]   .viewProjectText[_ngcontent-%COMP%]{background-color:#000;color:#fff;padding:10px;font-weight:700;transition:all .2s ease-in-out;text-decoration:none}.cardComponent[_ngcontent-%COMP%]   .viewProject[_ngcontent-%COMP%]   .viewProjectText[_ngcontent-%COMP%]:hover{background-color:#000000c7}.cardComponent[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{font-size:18px;font-weight:600;transition:font-weight .2s ease-in-out;padding:5px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:20px;flex-grow:1;padding:0 20px 20px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{font-size:14px;padding:0 10px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]{display:flex;gap:10px;justify-content:center;flex-wrap:wrap;padding:0 10px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]   .tagElement[_ngcontent-%COMP%]{font-size:10px;font-weight:700;background-color:#00000073;color:#fff;padding:5px 10px;width:-moz-fit-content;width:fit-content}.cardComponent[_ngcontent-%COMP%]:hover{box-shadow:0 0 7px #d9d9d9}@media only screen and (max-width: 990px){.cardComponent[_ngcontent-%COMP%]{width:clamp(250px,25vw,219px)}}@media only screen and (max-width: 630px){.cardContainer[_ngcontent-%COMP%]{display:flex;justify-content:center}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]{width:95%}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]{height:auto}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{height:100%;width:100%}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .viewProject[_ngcontent-%COMP%]{padding:0 25px}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]{justify-content:center;flex-grow:1;padding:5px 0 15px}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{justify-content:center}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], .cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]{padding:0 10px}.cardContainer[_ngcontent-%COMP%]   .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]   .tagElement[_ngcontent-%COMP%]{padding:5px}}',
            ],
          }));
        }
        return e;
      ...
      function zF(e, t) {
        ...
        if (2 & e) {
          const n = t.$implicit,
            r = Gr();
          (fe(1), ei("active", r.activeSub === n), fe(2), Zr(" ", n, " "));
        }
      }
      let qF = (() => {
          class e {
          ...
          class e {
            constructor() {
              ((this.itemLinks = [""]),
                (this.activeOption = "Programming"),
                (this.activeSub = "Web Development"),
                (this.activeOptionChangeToAppComponent = new De()));
            }
            ngOnInit() {
            ...
            static #t = (this.ɵcmp = pn({
              ...
              consts: [
                ...
                [1, "rightSectionContainer"],
                [1, "cardsContiner"],
                [3, "sub"],
              ],
              template: function (r, o) {
                (1 & r &&
                  (B(0, "div", 0)(1, "app-nav", 1),
                  wt("activeOptionChange", function (s) {
                    return o.onActiveOptionChange(s);
                  }),
                  Z(),
                  B(2, "app-sub-nav", 2),
                  wt("activeSubChange", function (s) {
                  ...
                  2 & r &&
                    (fe(2),
                    We("subLinks", o.itemLinks)("mainRoute", o.activeOption),
                    fe(3),
                    We("sub", o.activeSub)));
              },
              dependencies: [jF, BF, qF],
              styles: [
                ".topNavs[_ngcontent-%COMP%]{position:fixed;z-index:1;width:calc(100% - 261px);background-color:#d9d9d9}.rightSectionContainer[_ngcontent-%COMP%]{padding-top:212px}.rightSectionContainer[_ngcontent-%COMP%]   .cardsContiner[_ngcontent-%COMP%]   app-card[_ngcontent-%COMP%]{padding:10px;display:flex;justify-content:center;flex-wrap:wrap;margin-bottom:50px;gap:35px}@media only screen and (max-width: 990px){.cardsContiner[_ngcontent-%COMP%]   app-card[_ngcontent-%COMP%]{padding:20px;gap:25px}}@media only screen and (max-width: 630px){.cardsContiner[_ngcontent-%COMP%]   app-card[_ngcontent-%COMP%]{width:100%;gap:35px}}@media only screen and (max-width: 990px){.rightSectionContainer[_ngcontent-%COMP%]{padding-top:168px}}@media only screen and (max-height: 795px){.topNavs[_ngcontent-%COMP%]{width:calc(100% - 231px)}}@media only screen and (max-width: 630px){.topNavs[_ngcontent-%COMP%]{width:100%;top:132px}.rightSectionContainer[_ngcontent-%COMP%]{padding-top:300px}}@media only screen and (max-width: 420px){.rightSectionContainer[_ngcontent-%COMP%]{padding-top:257px}}",
              ],
            }));
          }
          return e;
            ...
            static #t = (this.ɵcmp = pn({
              ...
              template: function (r, o) {
                (1 & r &&
                  (B(0, "div", 0),
                  ht(1, "app-contact", 1),
                  B(2, "div", 2)(3, "app-portfolio", 3),
                  wt("activeOptionChangeToAppComponent", function (s) {
                    return o.onActiveOptionChangeToAppComponent(s);
                  }),
                  Z()()()),
                  2 & r && (fe(1), We("activeOption", o.specialty)));
              },
              dependencies: [LF, GF],
              styles: [
                ".appComponent[_ngcontent-%COMP%]{display:flex;background-color:#d9d9d9}.appComponent[_ngcontent-%COMP%]   app-contact[_ngcontent-%COMP%]{position:sticky;background-color:#d9d9d9;height:100vh;top:0}.appComponent[_ngcontent-%COMP%]   .portfolioBody[_ngcontent-%COMP%]{flex-grow:1}@media only screen and (max-width: 630px){.appComponent[_ngcontent-%COMP%]{flex-direction:column}.appComponent[_ngcontent-%COMP%]   app-contact[_ngcontent-%COMP%]{position:fixed;height:auto;z-index:2;width:100%}}",
              ],
            }));
          }
          return e;
        ...
        ZF = (() => {
          class e {
            ...
            static #t = (this.ɵmod = gn({ type: e, bootstrap: [WF] }));
            static #n = (this.ɵinj = qt({
              providers: [XN()],
              imports: [BN, RF, FF],
            }));
