  ...
  [179],
  {
    63: () => {
      ...
      function Zi(e, t) {
        ...
        const n = t ? ke : bE;
        return () =>
          ("function" == typeof e ? e() : e).map((r) => n(r)).filter(IE);
      }
      const ue = 0,
        w = 1,
        F = 2,
      ...
      function iu(e, t) {
        return e.createComment(
          (function _p(e) {
            return e.replace(iI, (t) => t.replace(sI, aI));
          })(t)
        );
      }
      function Ds(e, t, n) {
      ...
      function Mr(e) {
        ...
        return t
          ...
          ? En(e)
          : (function gu(e) {
              return (e = String(e)).match(ZI) ? e : "unsafe:" + e;
            })(N(e));
      }
      class E {
        constructor(t, n) {
          ...
          if (!i) return !1;
          {
            ...
            if (!a) {
              ...
              t({ provide: o, useFactory: u, deps: q }, o),
                ...
                t({ provide: Sr, useValue: () => I(o), multi: !0 }, o);
            }
            const c = i.providers;
            if (null != c && !a) {
              const u = e;
      ...
      const cM = Q({ provide: String, useValue: Q });
      function _u(e) {
        return null !== e && "object" == typeof e && cM in e;
      }
      function Hn(e) {
        return "function" == typeof e;
      }
      ...
      class xs extends ft {
          ...
          try {
            if (!(r & $.SkipSelf)) {
              ...
              if (void 0 === c) {
                ...
                (c = u && this.injectableDefInScope(u) ? Tr(Iu(t), As) : null),
        ...
        hydrate(t, n) {
          return (
            n.value === As && ((n.value = lM), (n.value = n.factory())),
      ...
      function Mu(e, t) {
        for (const n of e)
          Array.isArray(n) ? Mu(n, t) : n && dc(n) ? Mu(n.ɵproviders, t) : t(n);
      }
      const Rs = new E("AppId", { providedIn: "root", factory: () => mM }),
        mM = "ng",
      ...
      function mg(e) {
        let t = e._lView;
        return 2 === t[w].type ? null : (Mc(t) && (t = t[V]), t);
      }
      function ks(e, t, n) {
      ...
      let bn = (() => {
        class e {
          ...
          static #e = (this.__NG_ELEMENT_ID__ = AM);
        }
        return e;
      })();
      class Dg {}
      ...
      class Y {
        ...
        runTask(t, n, r, o) {
          const i = this._inner,
            s = i.scheduleEventTask("NgZoneEvent: " + o, t, BM, Sg, Sg);
          try {
      ...
      function S(e, t = $.Default) {
        const n = y();
        return null === n ? I(e, t) : np(Te(), n, R(e), t);
      }
      ...
      function Xg(e, t, n, r, o, i) {
        ...
        !(function dS(e, t, n) {
          ...
          for (let l = t.directiveStart; l < o; l++) {
            ...
            const g = null === c || null === s || Jf(t) ? null : MS(c, l, s);
            a.push(g);
          }
          null !== c &&
      ...
      function um(e, t) {
        for (let n = Op(e); null !== n; n = xp(n))
          for (let r = Me; r < n.length; r++) lm(n[r], t);
      }
      function NS(e, t, n) {
        lm(Ke(t, e), n);
      }
        ...
        create(t, n, r, o) {
          ...
          try {
            ...
            (Oe = Th(b, V)),
              p &&
                (function BS(e, t, n, r) {
                  if (r) Ec(e, n, ["ng-version", NM.full]);
                  else {
      ...
      function B() {
        ...
        const n = z();
        return (
          n.firstCreatePass && (ts(n, e), Ic(e) && n.queries.elementEnd(e)),
                        ...
                        if (-1 === s || e[s] !== o)
                          if (((n = ml(o, e, t, n, r)), null === i)) {
                            ...
                            void 0 !== c &&
                              ...
                              (c = ei(c, t.attrs, r)),
                              (function X0(e, t, n, r) {
                                e[In(n ? t.classBindings : t.styleBindings)] =
                                  r;
                              })(e, t, r, c));
                          } else
                            i = (function J0(e, t, n) {
          ...
          getOrCreateStandaloneInjector(n) {
            ...
            if (!this.cachedInjectors.has(n)) {
              const r = ag(0, n.type),
                o =
                  r.length > 0
                    ? Ml([r], this._injector, `Standalone[${n.type.name}]`)
                    : null;
      ...
      function Dy(e) {
        Cy(e);
        for (let t = Me; t < e.length; t++) aa(e[t]);
      }
      function aa(e) {
        const t = e[w];
                  ...
                  (function uC(e = [], t) {
                    return ht.create({
                      ...
                      providers: [
                        ...
                        { provide: Zl, useValue: new Set([() => (Mn = null)]) },
                        ...e,
                      ],
                    });
                  })(a, r)
        ...
        class e {
          ...
          bootstrapModuleFactory(n, r) {
            const o = (function yx(e = "zone.js", t) {
              return "noop" === e ? new qM() : "zone.js" === e ? new Y(t) : e;
            })(
              r?.ngZone,
              (function dC(e) {
                return {
      ...
      let ED = (() => {
        class e {
          ...
          static #e = (this.ɵfac = function (r) {
            return new (r || e)(I(ot), I(Rs), I(hg, 8), I(Ar));
          });
          static #t = (this.ɵprov = M({ token: e, factory: e.ɵfac }));
        }
        return e;
      ...
      class Nd extends Rd {
        constructor(t, n, r, o, i, s, a, c) {
          super(t, i, s, a),
            ...
            (this.styles = c ? ID(c, r.styles) : r.styles);
        }
        applyStyles() {
      ...
      const VP = cC(Fx, "browser", [
        ...
        ND = [
          ...
          ED,
          wD,
          { provide: Dg, useExisting: MD },
          { provide: class EN {}, useClass: IP, deps: [] },
          [],
        ];
      let UP = (() => {
          class e {
        ...
        return i.matched
          ? ((r = (function uk(e, t) {
              return (
                e.providers &&
                  !e._injector &&
                  (e._injector = Ml(e.providers, t, `Route: ${e.path}`)),
                e._injector ?? t
              );
            })(t, r)),
            (function Fk(e, t, n, r) {
      ...
      class Zk {
        ...
        recognize() {
          const t = Iw(this.urlTree.root, [], [], this.config).segmentGroup;
                ...
                : this.getChildConfig((t = r._injector ?? t), r, o).pipe(
                    Ot(({ routes: u }) => {
                      const l = r._loadedInjector ?? t,
                        ...
                        { segmentGroup: p, slicedSegments: g } = Iw(n, f, h, u);
          ...
          .pipe(
            ...
            ee((n) =>
              n instanceof On || n instanceof to
                ? Ni.COMPLETE
                : n instanceof Mi && (0 === n.code || 1 === n.code)
                ? Ni.REDIRECTING
                : Ni.FAILED
            ),
        ...
        class e {
            ...
            const n = this.navigationTransitions.events.subscribe((r) => {
              try {
                ...
                if (r instanceof $a)
                  ...
                  this.scheduleNavigation(i, Ii, null, s, {
                    resolve: o.resolve,
                    reject: o.reject,
                    promise: o.promise,
                  });
          ...
          initialNavigation() {
            if (
              ...
              this.navigateToSyncWithBrowser(this.location.path(!0), Ii, n);
            }
          }
          ...
          navigateByUrl(n, r = { skipLocationChange: !1 }) {
            ...
            return this.scheduleNavigation(i, Ii, null, r);
          }
        ...
        class e {
          ...
          processRoutes(n, r) {
            ...
            for (const i of r) {
              i.providers &&
                !i._injector &&
                (i._injector = Ml(i.providers, n, `Route: ${i.path}`));
          ...
          static #e = (this.ɵfac = function (r) {
            return new (r || e)(I(yt), I(Ky), I(ft), I(kw), I(rf));
          });
          static #t = (this.ɵprov = M({
            token: e,
            factory: e.ɵfac,
            ...
            return {
              ...
              providers: [
                ...
                r?.preloadingStrategy
                  ...
                  : [],
                { provide: sC, multi: !0, useFactory: IF },
      ...
      let kF = (() => {
          ...
          return (
            (e.ɵfac = function (n) {
              return new (n || e)(I(Y), I(ot), I(PF, 8));
            }),
      ...
      const qw = [
        ...
        },
        {
          ...
          link: "app.https://ranemyatakan.com/",
      ...
      function $F(e, t) {
        if (
          ...
          nt("href", n.link, Mr),
            re(2),
            nt("src", n.image || "../../assets/images/default image.png", Mr),
            re(3),
            ta(n.title),
            re(2),
            ta(n.description),
      ...
      function VF(e, t) {
        if ((1 & e && (j(0, "div"), Jo(1, $F, 10, 5, "a", 1), B()), 2 & e)) {
          const n = t.$implicit,
            r = Ko();
      ...
      let BF = (() => {
        class e {
          ...
          static #t = (this.ɵcmp = gn({
            ...
            dependencies: [vd, QC],
            styles: [
              '.cardComponent[_ngcontent-%COMP%]{display:flex;flex-direction:column;text-align:center;gap:11px;border:solid 2px #d9d9d9;width:clamp(100px,25vw,219px);padding-bottom:15px;color:#000;text-decoration:none;transition:box-shadow .2s ease-in-out;height:100%}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]{overflow:hidden;position:relative;height:clamp(110px,20vw,130px)}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{width:100%;height:100%;object-fit:cover}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]:after{content:"";position:absolute;top:0;left:0;width:100%;height:100%}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:11px;flex-grow:1}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{font-size:16px;font-weight:600;transition:font-weight .2s ease-in-out;padding-top:5px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{font-size:14px;color:#565656;padding:0 10px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]{display:flex;gap:10px;justify-content:center;flex-wrap:wrap;padding:0 10px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]   .tagElement[_ngcontent-%COMP%]{font-size:10px;font-weight:700;background-color:#5f5b58;color:#fff;padding:5px 10px;width:-moz-fit-content;width:fit-content}.cardComponent[_ngcontent-%COMP%]:hover{box-shadow:0 0 7px #d9d9d9}.cardComponent[_ngcontent-%COMP%]:hover   .descriptionAndTags[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{font-weight:700}@media only screen and (max-width: 990px){.cardComponent[_ngcontent-%COMP%]{width:clamp(100px,25vw,219px)}}@media only screen and (max-width: 630px){.cardComponent[_ngcontent-%COMP%]{width:100%;flex-direction:row;gap:unset;padding-bottom:0}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]{width:clamp(140px,45%,300px);height:auto}.cardComponent[_ngcontent-%COMP%]   .cardImage[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{height:100%;width:100%}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]{justify-content:center;flex-grow:1;padding:5px 0 15px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{justify-content:center}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], .cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]{padding:0 10px}.cardComponent[_ngcontent-%COMP%]   .descriptionAndTags[_ngcontent-%COMP%]   .tags[_ngcontent-%COMP%]   .tagElement[_ngcontent-%COMP%]{padding:5px}}',
            ],
          }));
        }
        return e;
        ...
        qF = (() => {
          class e {
            ...
            static #t = (this.ɵcmp = gn({
              ...
              styles: [
                ".cardsContiner[_ngcontent-%COMP%]   app-card[_ngcontent-%COMP%]{padding:10px;display:flex;justify-content:center;flex-wrap:wrap;margin-bottom:50px;gap:25px}@media only screen and (max-width: 630px){app-card[_ngcontent-%COMP%]{width:100%}}",
              ],
            }));
          }
          return e;
